...
(function() {
  ...
  BubbleChart = (function() {
    ...
    BubbleChart.prototype.create_nodes = function() {
      ...
      this.data.forEach(function(d) {
        ...
        node = {
          id: d.Regione,
          radius: _this.radius_scale(parseInt(d.Followees)),
          value: d.Followees,
          iscritti: d.Iscritti,
          //name: d.grant_title,
          //org: d.organization,
    ...
    BubbleChart.prototype.create_vis = function() {
      ...
      .attr("fill", function(d){
          console.info(d.iscritti);
          if(0 <= d.iscritti &&  d.iscritti < 1000) {
            return "#33FFFF";
          }
          else if(1000 <= d.iscritti &&  d.iscritti <= 5000) {
            return "#0099FF";
          } else return "#000099";
      })
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content = "<span class=\"name\"></span><span class=\"value\"> <strong>" + data.id + "</strong></span><br/>";
      content += "<span class=\"name\">Area:</span><span class=\"value\"> " + data.year + "</span><br/>";
      content += "<span class=\"name\">Followees:</span><span class=\"value\"> " + data.value +" </span><br/>";
      content += "<span class=\"name\">Iscritti:</span><span class=\"value\"> " + data.iscritti + "</span>";
  ...
  $(function() {
    ...
    return d3.csv("data/social-university-twitter.csv", render_vis);
  });
