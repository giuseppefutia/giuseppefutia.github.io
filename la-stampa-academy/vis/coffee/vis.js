...
(function() {
  ...
  BubbleChart = (function() {
    ...
    BubbleChart.prototype.create_vis = function() {
      ...
      that = this;
      this.circles.enter().append("circle").attr("r", 0).attr("fill", "#90EE90")
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content += "<span class=\"name\">Spesa:</span><span class=\"value\"> " + data.value.splice(1, 0, ",") + "% del PIL</span><br/>";
      content += "<span class=\"name\">Area:</span><span class=\"value\"> " + data.year + "</span>";
  ...
  $(function() {
    ...
    return d3.csv("data/spesa-istruzione-formazione-area.csv", render_vis);
  });
